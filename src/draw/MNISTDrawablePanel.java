...
public class MNISTDrawablePanel extends JPanel{
	private int width;
	private int height;
	private int xSize;
	private int ySize;
	...
	public MNISTDrawablePanel(int width, int height, int xSize, int ySize){
		this.width = width;
		this.height = height;
		this.xSize = xSize;
		this.ySize = ySize;
	...
	public Tensor getData(int outputX1, int outputY1, int outputX2, int outputY2){
