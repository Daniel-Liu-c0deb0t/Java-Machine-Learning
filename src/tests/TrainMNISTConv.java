...
public class TrainMNISTConv{
	public static void main(String[] args) throws Exception{
		...
		nn.add(new ConvLayer(5, 1, 32, 2, Activation.relu));
		nn.add(new MaxPoolingLayer(2, 2));
		nn.add(new ConvLayer(5, 1, 64, 2, Activation.relu));
		nn.add(new MaxPoolingLayer(2, 2));
		...
		nn.fit(Utils.reshapeAll(x, 28, 28, 1), y, 100, 100, Loss.softmaxCrossEntropy, new AdamOptimizer(0.01), null, true, false, false);
